...
def expression_break(singn,expression):
    value = expression.split(singn,1)
    return value
...
def equal():
    ...
    try:
        ...
        if expression.find("(") > 0:
            ...
            result = multiplay(data[0],data[1]) 
...
btn_tan = Button(window,text="tna",
                background="gray11",
...
btn_cos = Button(window,text="cos",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("cos("))
btn_cos.grid(row=1,column=1,sticky=E+W,ipady=5)

btn_sin = Button(window,text="sin",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("sin("))
btn_sin.grid(row=1,column=2,sticky=E+W,ipady=5)

btn_sqrt = Button(window,text="sqrt √ ",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
...
btn_log = Button(window,text="log",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("log("))
btn_log.grid(row=2,column=0,sticky=E+W,ipady=5)

btn_ln = Button(window,text="ln",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("ln("))
btn_ln.grid(row=2,column=1,sticky=E+W,ipady=5)

btn_deg = Button(window,text="deg",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("deg("))
btn_deg.grid(row=2,column=2,sticky=E+W,ipady=5)

btn_rad = Button(window,text="rad",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
...
btn_fac = Button(window,text="fac x!",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("fac("))
btn_fac.grid(row=3,column=0,sticky=E+W,ipady=5)

btn_power = Button(window,text="power",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("^"))
btn_power.grid(row=3,column=1,sticky=E+W,ipady=5)

btn_remainder = Button(window,text="rem",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("rem"))
btn_remainder.grid(row=3,column=2,sticky=E+W,ipady=5)

btn_pi = Button(window,text="π",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
...
def clear ():
    entry.delete(0,"end")
btn_clear = Button(window,text="C",background="gray5",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=clear)
...
btn_backspace = Button(window,text="B",background="gray5",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=back)
...
btn_7 = Button(window,text="7",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press(7))
btn_7.grid(row=5,column=0,sticky=E+W,ipady=5)

btn_8 = Button(window,text="8",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press(8))
btn_8.grid(row=5,column=1,sticky=E+W,ipady=5)

btn_9 = Button(window,text="9",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press(9))
btn_9.grid(row=5,column=2,sticky=E+W,ipady=5)

btn_div = Button(window,text="/",background="gray5",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("/"))
...
btn_4 = Button(window,text="4",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press(4))
btn_4.grid(row=6,column=0,sticky=E+W,ipady=5)

btn_5 = Button(window,text="5",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press(5))
btn_5.grid(row=6,column=1,sticky=E+W,ipady=5)

btn_6 = Button(window,text="6",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press(6))
btn_6.grid(row=6,column=2,sticky=E+W,ipady=5)

btn_multiply = Button(window,text="*",background="gray5",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("*"))
...
btn_1 = Button(window,text="1",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press(1))
btn_1.grid(row=7,column=0,sticky=E+W,ipady=5)

btn_2 = Button(window,text="2",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press(2))
btn_2.grid(row=7,column=1,sticky=E+W,ipady=5)

btn_3 = Button(window,text="3",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press(3))
btn_3.grid(row=7,column=2,sticky=E+W,ipady=5)

btn_sub = Button(window,text="-",background="gray5",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("-"))
...
btn_dot = Button(window,text=".",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("."))
btn_dot.grid(row=8,column=0,sticky=E+W,ipady=5)

btn_0 = Button(window,text="0",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("0"))
btn_0.grid(row=8,column=1,sticky=E+W,ipady=5)

btn_e = Button(window,text="e",background="gray11",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press(2.71828))
btn_e.grid(row=8,column=2,sticky=E+W,ipady=5)

btn_add = Button(window,text="+",background="gray5",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command=lambda:press("+"))
...
btn_equal = Button(window,text="=",background="DarkOrange1",foreground="White",
                font=font_value,borderwidth=1,relief= SOLID,
                command=equal)
...
def close():
    window.destroy()
btn_close = Button(window,text="Close",background="gray5",foreground="DarkOrange1",
                font=font_value,borderwidth=1,relief= SOLID,
                command= close)
